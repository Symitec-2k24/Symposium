...
$(window).load(function(){
  var $post_para = $(".post-para"),
   ...
   setTimeout(function(){$pre_para.shuffleLetters({ "text": "to" });$digm.shuffleLetters({ "text": "posium" });$digm.text("digm");},1000);
   ...
   // setTimeout(function(){$pre_para.addClass("invisible");$post_para.fadeIn(600); $digm.text("itec");},4000);
    ...
    $digm.css("transform", "scale(0.5)").html("itec<br>cy<br>ai<br>");
}, 4000);
});
